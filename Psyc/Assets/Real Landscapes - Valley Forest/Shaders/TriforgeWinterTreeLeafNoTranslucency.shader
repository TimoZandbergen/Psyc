...
Shader "TriForge/Winter Forest/Leaf - No Translucency"
{
	...
	SubShader
	{
		...
		#pragma surface surf Standard keepalpha addshadow fullforwardshadows nolightmap  nodirlightmap nometa dithercrossfade vertex:vertexDataFunc 
		struct Input
		{
			float3 worldPos;
			float2 uv_texcoord;
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			half ifLocalVar109_g2 = 0;
			if( abs( TFW_WindDirection.x ) > 0.0 )
				ifLocalVar109_g2 = 1.0;
			else if( abs( TFW_WindDirection.x ) == 0.0 )
				ifLocalVar109_g2 = 0.0;
			half ifLocalVar110_g2 = 0;
			if( abs( TFW_WindDirection.z ) > 0.0 )
				ifLocalVar110_g2 = 0.0;
			half ifLocalVar112_g2 = 0;
			if( ifLocalVar109_g2 == ifLocalVar110_g2 )
				ifLocalVar112_g2 = 1.0;
			half3 lerpResult123_g2 = lerp( TFW_WindDirection , half3(1,0,0) , ifLocalVar112_g2);
			half3 worldToObjDir38_g2 = normalize( mul( unity_WorldToObject, float4( lerpResult123_g2, 0 ) ).xyz );
			half3 lerpResult39_g2 = lerp( worldToObjDir38_g2 , TFW_WindDirection , TFW_DirectionRandomness);
			half3 WindDirection41_g2 = lerpResult39_g2;
			half WindSpeed19_g2 = ( _WindSpeed * TFW_WindSpeed );
			float3 ase_worldPos = mul( unity_ObjectToWorld, v.vertex );
			half4 transform2_g2 = mul(unity_WorldToObject,half4( ase_worldPos , 0.0 ));
			half2 WorldSpaceUv9_g2 = (( transform2_g2 / ( -100.0 * ( 1.0 * _WindNoiseScale ) ) )).xz;
			float2 uv2_TexCoord12_g2 = v.texcoord1.xy * float2( 0,0 ) + WorldSpaceUv9_g2;
			half2 temp_cast_1 = (uv2_TexCoord12_g2.x).xx;
			half2 panner13_g2 = ( 1.0 * _Time.y * ( float2( 0.12,0 ) * WindSpeed19_g2 ) + temp_cast_1);
			half simplePerlin3D11_g2 = snoise( half3( panner13_g2 ,  0.0 )*0.5 );
			half MainWindBending86_g2 = simplePerlin3D11_g2;
			half WindRotation32_g2 = radians( ( ( (-0.6 + (MainWindBending86_g2 - -1.0) * (1.0 - -0.6) / (1.0 - -1.0)) * TFW_WindStrength ) * 25.0 ) );
			float3 ase_vertex3Pos = v.vertex.xyz;
			half3 rotatedValue42_g2 = RotateAroundAxis( float3( 0,0,0 ), ase_vertex3Pos, WindDirection41_g2, WindRotation32_g2 );
			half3 WindOutput394 = ( ( rotatedValue42_g2 - ase_vertex3Pos ) * TFW_EnableWind );
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			half saferPower193 = max( ( lerpResult424 * ( (( 1.0 - _SnowDelay ) + (_SnowMaxAmount - 0.0) * (2.0 - ( 1.0 - _SnowDelay )) / (2.0 - 0.0)) * TFW_SnowAmount ) ) , 0.0001 );
			...
			o.Alpha = 1;
			half OpacityMap235 = tex2DNode179.a;
			clip( OpacityMap235 - _Cutoff );
		}
...
/*ASEBEGIN
Version=18912
1920;6;1920;1013;3667.008;2230.548;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;404;-2971.896,-1059.002;Inherit;False;Property;_NormalScale;Normal Scale;4;0;Create;True;0;0;0;False;0;False;0.5;0.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;186;-2712.063,-1107.086;Inherit;True;Property;_Normal;Normal;3;0;Create;True;0;0;0;False;0;False;-1;None;6e99ed2906de2ed4b96fded5eca4347c;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;77;-3780.802,2939.128;Inherit;False;Property;_WindSpeed;Wind Speed;10;0;Create;True;0;0;0;False;0;False;1;2;0;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;6;-3696.023,3072.537;Inherit;False;Property;_WindNoiseScale;Wind Noise Scale;11;0;Create;True;0;0;0;False;0;False;1;0.3;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.VertexColorNode;428;-3803.657,3793.452;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;458;-3463.134,610.7793;Inherit;False;Property;_LeafFlutterScale;Leaf Flutter Scale;13;0;Create;True;0;0;0;False;0;False;1;1;0.1;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.StaticSwitch;427;-640.1131,-1751.259;Inherit;False;Property;_FlipBackNormals;Flip Back Normals;8;0;Create;True;0;0;0;False;0;False;0;0;0;True;_TFW_FLIPNORMALS;Toggle;2;Key0;Key1;Create;False;False;9;1;FLOAT3;0,0,0;False;0;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;465;-5412.826,-81.38245;Inherit;False;Property;_SnowDelay;Snow Delay;20;0;Create;True;0;0;0;False;0;False;0;0;0;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;362;-2847.866,993.5286;Inherit;False;Property;_DownwardForce;DownwardForce;14;0;Create;True;0;0;0;False;0;False;0.5;2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;189;-5416.276,-338.4487;Inherit;False;Property;_SnowMaxAmount;Snow Max Amount;16;0;Create;True;0;0;0;False;0;False;2;2;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;356;-2858.497,577.532;Inherit;False;Property;_SidewaysForce;SidewaysForce;15;0;Create;True;0;0;0;False;0;False;1.5;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;422;-5444.837,-685.1123;Inherit;False;421;FinalNormal;1;0;OBJECT;;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;426;-5286.495,-455.8022;Inherit;False;Property;_SnowNormalsInfluence;Snow Normals Influence;18;0;Create;True;0;0;0;False;0;False;0;0.744;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;180;-2715.273,-1329.061;Inherit;True;Property;_MaskMap;Mask Map;5;0;Create;True;0;0;0;False;0;False;-1;None;033274e0cc67f1340995a576c84dec92;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;436;-3065.484,3959.394;Inherit;False;Property;_VertexAOStrength;Vertex AO Strength;7;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;194;-4670.726,-446.7243;Inherit;False;Property;_SnowMaskSharpness;Snow Mask Sharpness;17;0;Create;True;0;0;0;False;0;False;1.5;1.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;444;-3380.321,-130.8038;Inherit;False;Property;_SnowVertexAOInfluence;Snow Vertex AO Influence;19;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.PowerNode;213;-3984.192,-221.3357;Inherit;False;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;70;-2823.126,2413.056;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;414;-2532.292,1318.868;Inherit;False;Property;_LeafFlutterStrength;Leaf Flutter Strength;12;0;Create;True;0;0;0;False;0;False;0;0.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;179;-2746.45,-1823.394;Inherit;True;Property;_MainTex;Albedo;2;0;Create;False;0;0;0;False;0;False;-1;None;7e59775cae4cc8e4c8470ab7c8bae992;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;467;-2720.337,-1570.698;Inherit;False;Property;_Color;Color;1;0;Create;True;0;0;0;False;0;False;1,1,1,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;38;-2646.86,2973.299;Inherit;False;Property;_WindStrength;Wind Strength;9;0;Create;True;0;0;0;False;0;False;0.3;1;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;212;-196.6466,200.7104;Inherit;False;Property;_Smoothness;Smoothness;6;0;Create;True;0;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;515.4592,128.1971;Half;False;True;-1;2;ASEMaterialInspector;0;0;Standard;TriForge/Winter Forest/Leaf - No Translucency;False;False;False;False;False;False;True;False;True;False;True;False;True;False;True;False;False;False;False;False;True;Off;0;False;-1;0;False;-1;False;5;False;-1;5;False;-1;False;5;Masked;0.3;True;True;0;False;TransparentCutout;;AlphaTest;All;18;all;True;True;True;True;0;False;-1;False;255;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;5;True;0;1;False;-1;10;False;-1;0;1;False;-1;10;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;0;-1;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;3;Pragma;instancing_options procedural:setup;False;;Custom;Pragma;multi_compile GPU_FRUSTUM_ON __;False;;Custom;Include;VS_indirect.cginc;False;9e72312817e6e10468532362fcec98c2;Custom;0;0;False;1;False;-1;0;False;-1;False;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=DC8C96390339B97F034401538E9FB1E0F2C3198B